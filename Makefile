...
TRACER_FLAGS := -I$(INC_DIR_TRACER) $(STD_FLAGS)
MONITOR_FLAGS := -I$(INC_DIR_MONITOR) $(STD_FLAGS)

DEBUG_FLAGS_TRACER := -I$(INC_DIR_TRACER) $(STD_DEBUG_FLAGS)
DEBUG_FLAGS_MONITOR := -I$(INC_DIR_MONITOR) $(STD_DEBUG_FLAGS)
...
.PHONY: clean
RM_DIRS := $(BASE_BUILD_DIR) $(BIN_DIR) $(TARGET_EXEC_TRACER) $(TARGET_EXEC_MONITOR)
RED := \033[0;31m
NC := \033[0m
clean:
